...
import random
from random_ import generate_random_queen_positions


def is_valid_queen_position(queens):
...
def main():
    queens = generate_random_queen_positions()
    print("Queen positions:", queens)
    print("Valid position:", is_valid_queen_position(queens))
